    ...
    <div class="card-columns">
        ...
        <div class="wrap__masonary-card">
            <div class="card bg__card-shadow">
                <div class="card-img-top">
                    <a href="#" class="">
                        <img class=" img-fluid h-240  " src="images/placeholder/500x400.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="card-body">
        ...
        <div class="wrap__masonary-card">
            <div class="card">
                <div class="card-img-top">
                    ...
                    <a href="#" class="">
                        <img class=" img-fluid h-150  " src="images/placeholder/500x400.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="card-body">
        ...
        <div class="wrap__masonary-card">
            <div class="card">
                <div class="card-img-top">
                    <a href="#" class="">
                        <img class=" img-fluid h-270  " src="images/placeholder/500x400.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="card-body">
        ...
        <div class="wrap__masonary-card">
            <div class="card">
                <div class="thumbnail-cover ">
                    <a href="#">
                        <img class="img-fluid h-540" src="images/placeholder/600x600.jpg"
                            alt="Card image">
                    </a>
                ...
                <div class="masonary__title">
                    <h4>
                        <a href="#">Expert Tips: How To Become A Professional Travel Blogger </a>
                    </h4>
                    <p>
                        When we get out of the glass bottle of our ego and when we escape like the squirrels in the...
                    </p>
                </div>
                <div class="masonary__title-info-author">
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <span>
                                By David Hall,
        ...
        <div class="wrap__masonary-card">
            <div class="card">
                <div class="card-img-top">
                    ...
                    <a href="#" class="">
                        <img class=" img-fluid h-360  " src="images/placeholder/500x400.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="card-body">
